...
========================================*/
    ...
    $(document).ready(function () {
        ...
        $('.rs-swiper .swiper').each(function (index) {
            ...
            var gap = (($(this).data('no-gap') === true) ? 0 : 0);
		...
		var stickyHead = $(".rs-header-area.rs-header-one");
        $(window).on("scroll", function () {
            if ($(this).scrollTop() > 200) {
                stickyHead.addClass("active");
            } else {
                stickyHead.removeClass("active");
            }
        });
...
var swiper4 = new Swiper('.gallery-slider', {
			pagination: {
